...
function Register() {
  ...
  const handleSubmit = async(e) => {
   ...
   const res = await api.post('/auth/register', payload);
      ...
      setError(error.res?.data?.message || "Utilisateur déjà existant");
    }
  };
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full p-2.5 rounded bg-[#0b0f19] border border-gray-800 text-white text-sm font-medium focus:border-cyan-500 outline-none"
            >
